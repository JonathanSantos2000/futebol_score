...
$month = $monthSelect;
$year = $yearSelec;
$matches = conexaoAPI("http://api.football-data.org/v4/competitions/2016/matches?dateFrom={$year}-{$month}-{$day}&dateTo={$year}-{$month}-{$day}", $chave);
$arrayGames = array();
...
$ranks = conexaoAPI("http://api.football-data.org/v4/competitions/ELC/standings?season={$year}", $chave);
$arrayRank = array();
...
$topPlayers = conexaoAPI("http://api.football-data.org/v4/competitions/ELC/scorers?season={$year}", $chave);
...
<main>
    <div class="col-left">
        ...
        <div class="rank">
            <h1 class="title-rank">Classificação - Championship</h1>
            <br>
    ...
    <div class="col-center">
        <div class="title-img">
            ...
            <div>
                <h1 class="title">Inglaterra</h1>
                <h1 class="sub-title">Championship</h1>
            </div>
        </div>
