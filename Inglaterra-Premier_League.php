...
$month = $monthSelect;
$year = $yearSelec;
$matches = conexaoAPI("http://api.football-data.org/v4/competitions/2021/matches?dateFrom={$year}-{$month}-{$day}&dateTo={$year}-{$month}-{$day}", $chave);
$arrayGames = array();
...
$ranks = conexaoAPI("http://api.football-data.org/v4/competitions/PL/standings?season={$year}", $chave);
$arrayRank = array();
...
$topPlayers = conexaoAPI("http://api.football-data.org/v4/competitions/PL/scorers?season={$year}", $chave);
...
<main>
    <div class="col-left">
        ...
        <div class="rank">
            <h1 class="title-rank">Classificação - Premier League</h1>
            <br>
    ...
    <div class="col-center">
        <div class="title-img">
            <img src="https://crests.football-data.org/770.svg" alt="flag-brasil">
            <div>
                <h1 class="title">Inglaterra</h1>
                <h1 class="sub-title">Premier League</h1>
            </div>
        </div>
