...
$month = $monthSelect;
$year = $yearSelec;
$matches = conexaoAPI("http://api.football-data.org/v4/competitions/2013/matches?dateFrom={$year}-{$month}-{$day}&dateTo={$year}-{$month}-{$day}", $chave);
$arrayGames = array();
...
$ranks = conexaoAPI("http://api.football-data.org/v4/competitions/BSA/standings?season={$year}", $chave);
$arrayRank = array();
...
$topPlayers = conexaoAPI("http://api.football-data.org/v4/competitions/BSA/scorers?season={$year}", $chave);
...
<main>
    <div class="col-left">
        ...
        <div class="rank">
            <h1 class="title-rank">Classificação - Brasileirão Série A</h1>
            <br>
    ...
    <div class="col-center">
        <div class="title-img">
            <img src="../futebol_score/assets/IMG/brasil.png" alt="flag-brasil">
            <div>
                <h1 class="title">Brasil</h1>
                <h1 class="sub-title">Brasileirão Série A</h1>
            </div>
        </div>
